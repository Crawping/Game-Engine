...
float Engine::Time::GetTotalSecondsElapsed()
{
	{
...
float Engine::Time::GetSecondsElapsedThisFrame()
{
	{
		const bool result = InitializeIfNecessary();
		assert(result);
...
bool Engine::Time::Initialize(std::string* o_errorMessage)
{
