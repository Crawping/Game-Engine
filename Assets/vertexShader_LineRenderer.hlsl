...
void main(in const float3 i_position_world : POSITION, in const float3 i_color : COLOR0, in const float2 i_uvs : TEXCOORD0,
	out float4 o_position_screen : POSITION, out float3 o_color : COLOR0, out float2 o_uvs : TEXCOORD0)
{
	// Calculate position
	{
